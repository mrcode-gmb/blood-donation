...
const getDonorCetificate = (e) => {
  form.blood_certificate = e.target.files[0];
};

const cscCertificate = (e) => {
  form.csc_certificate = e.target.files[0];
};
...
const form = useForm({
  ...
  doctor_email: "",
  notes: "",
  csc_certificate: null,
});

const submit = () => {
  let routePost = form.role == "3" ? "/register-donor" : "/hostpitals/register";
  ...
  <div class="main">
    ...
    <section id="mainbody">
      <div class="main-body">
        ...
        <div
          ...
          v-if="
            ($page.props.auth.user.role == '3' &&
              $page.props.auth.user.is_active == '1') ||
            ($page.props.auth.user.role == '4' && $page.props.auth.user.is_active == '1')
          "
        >
          <div class="tabs" id="tabls">
            <div class="full-chart">
              <div class="chart-title">
                ...
                <p>
                  Congratulation your application has been submited success fully we
                  contact you shortly through email or phone number
                </p>
              </div>
              <div class="dont-have">
                <img
              ...
              <div class="create-app">
                <Link :href="route('dashboard')"> Review </Link>
              </div>
            </div>
            <br />
          </div>
              ...
              >
                <div class="form-body form-padding-0">
                  <div class="form-group">
                    ...
                    <label for=""
                      >Select role first <span class="text-danger">*</span></label
                    >
                  </div>
                  <div class="form-hospital d-none" id="hospitalCheck">
                    ...
                    <div class="grid grid:3 gap10">
                      <div class="form-al">
                        ...
                        <InputError
                          ...
                          :message="form.errors.hospital_name"
                        />
                      </div>
                      <div class="form-al">
                        <div class="form-group">
                          <input
                            type="text"
                            placeholder=" "
                            v-model="form.hospital_moto"
                          />
                          <label for=""
                            >Moto name <span class="text-danger">*</span></label
                          >
                        </div>
                        <InputError
                          class="password-alert"
                          :message="form.errors.hospital_moto"
                        />
                      </div>
                      <div class="form-group">
                        <select
                      ...
                      <div class="form-al">
                        ...
                        <InputError
                          class="password-alert"
                          :message="form.errors.hospital_lga"
                        />
                      </div>
                      ...
                      <div class="form-al">
                        ...
                        <InputError
                          class="password-alert"
                          :message="form.errors.hospital_postal_code"
                        />
                      </div>
                      <div class="form-alt">
                        <div class="form-group">
                    ...
                    <div class="grid grid:3 gap10">
                      ...
                      <div class="form-al">
                        <div class="form-group">
                          ...
                          />
                          <label for=""
                            >Hospital email <span class="text-danger">*</span></label
                          >
                        </div>
                        <InputError
                          class="password-alert"
                      ...
                      <div class="form-al">
                        <div class="form-group">
                          <select id="" v-model="form.blood_donation_center_availability">
                            <option value="" hidden>
                              Blood Donation Center Availability
                            </option>
                      ...
                      <div class="form-al">
                        <div class="form-group">
                          <select id="" v-model="form.blood_donation_accepted">
                            <option value="" hidden>
                              Types of Blood Donation Accepted
                            </option>
                    ...
                    <div class="grid grid:3 gap10">
                      <div class="form-al">
                        <div class="form-group">
                          <select id="" v-model="form.accreditation_status">
                            <option value="" hidden>
                              Select Hospital Licensing Type
                            </option>
                            ...
                            <option value="primary healthcare center">
                              Primary Healthcare Center
                            </option>
                            <option value="teaching hospital">Teaching Hospital</option>
                            <option value="state licensed hospital">
                              State Health Ministry Licensed Hospital
                            </option>
                            <option value="local government hospital">
                              Local Government Health Center
                            </option>
                            <option value="nhis licensed hospital">
                              NHIS Licensed Hospital
                            </option>
                            <option value="ngo hospital">NGO Hospital</option>
                          </select>
                          <label for=""> <span class="text-danger">*</span></label>
                        </div>
                        <InputError
                      ...
                      <div class="form-al">
                        <div class="form-group">
                          ...
                          />
                          <label for=""
                            >Enter Hospital Licensing Number
                    ...
                    <div class="grid grid:3 gap10">
                      <div class="form-al">
                        ...
                        <InputError
                          class="password-alert"
                          :message="form.errors.doctor_name"
                        />
                      </div>
                      <div class="form-al">
                        <div class="form-group">
                          <input
                            type="number"
                            placeholder=" "
                            v-model="form.doctor_gsm"
                          />
                          <label for=""
                            >Doctor GSM <span class="text-danger">*</span></label
                          >
                        </div>
                        <InputError
                          class="password-alert"
                          :message="form.errors.doctor_gsm"
                        />
                      </div>
                      <div class="form-al">
                        <div class="form-group">
                          ...
                          />
                          <label for=""
                            >Doctor email <span class="text-danger">*</span></label
                          >
                        </div>
                        <InputError
                          class="password-alert"
                    ...
                    <div class="grid grid:3 gap10 mt-1">
                      <div class="form-group">
                        <input
                          type="file"
                          name="csc_certificate"
                          @change="cscCertificate"
                        />
                        <label for=""
                          >CSC Certificate <span class="text-danger">*</span></label
                        >
                      </div>
                      <div class="form-alt">
                        <div class="form-group">
                        ...
                        <InputError class="password-alert" :message="form.errors.notes" />
                      </div>
                    </div>
                    <div class="mt-1">
                      <div class="checkBox">
                  ...
                  <div class="form-donor-user d-none" id="donorCheck">
                    ...
                    <div class="grid grid:3 gap10 mt-1">
                      <div class="form-group">
                        <input
                          type="file"
                          name="blood_certificate"
                          @change="getDonorCetificate"
                        />
                        <label for=""
                          >Pepar Front <span class="text-danger">*</span></label
                        >
                      </div>
                      <div class="form-alt">
                        <div class="form-group">
                          <textarea
                            name=""
                            placeholder="Reason To Give The Blood"
                            v-model="form.reason"
                          ></textarea>
                          <label for=""> <span class="text-danger">*</span></label>
                        </div>
        ...
        <div
          v-else-if="
            $page.props.auth.user.role == '3' && $page.props.auth.user.is_active == '2'
          "
        >
          <div class="tabs" id="tabls">
            <div class="full-chart">
              <div class="chart-title flex-class">
                ...
                <div class="circle-text">
                  <p>
                    Hi, {{ $page.props.auth.user.name }} Congratulation Your Account Is
                    Active
                  </p>
                </div>
              </div>
