                    ...
                    <div class="str">
                        ...
                        <div class="full-chart">
                            <div class="chart-title flex-class">
                                <div class="circle-success" style="background: red;">
                                    <i class="fa fa-question"></i>
                                </div>
                                <div class="circle-text">
                                    <p>Your blood has been expired </p>
                                </div>
                            </div>
                        </div>
                        <div class="table-st" id="bloodBanks">
                            <div class="table-st-head">
                                <h4>Blood Bank Expired</h4>
                            ...
                            <div class="table-body">
                                <table class="student-data">
                                    ...
                                    <tr class="searchtab rowBlood" v-for="bloodInventories in bloodInventory"
                                        ...
                                        <td>
                                            <div class="status-reject" v-if="bloodInventories.is_active == 1">
                                                Expired
                                            </div>
                                        </td>
                                        <td>
