                            ...
                            <div class="chart-title pb-0-px">
                                <div class="profile-card">
                                    ...
                                    <div class="profile-menu">
                                        ...
                                        <div v-else-if="$page.props.auth.user.role == '1'">
                                            <div class="pyx status" v-if="hospotals[0].is_active == 1"
                                                @click="openModal(true)">
                                                Pendding
                                            </div>
                                            <div class="pyx status-approved" v-else-if="hospotals[0].is_active == 2"
                                                @click="openModal(true)">
                                                Approved
                                            </div>
                                            <div class="pyx status-reject" v-else-if="hospotals[0].is_active == 3"
                                                @click="openModal(true)">
                                                Decline
                                            </div>
                                            ...
                                            <div class="modal d-none" id="editModal">
                                                <div class="modal-dialog">
                                                    ...
                                                    <input type="hidden" :value="hospotals[0].user_id_none" id="select">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="profile-tabs-new">
                                    <div class="profile-tab">
                                        ...
                                        <li>
                                            <span href="#!" @click="openBloodBank(true)" v-if="$page.props.auth.user.id == hospotals[0].user_id_none">Edit profile</span>
                                        </li>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-st d-none" id="bloodBanks" >
                            <div class="table-st-head">
                                ...
                                <div class="input-seach">
                                    <input type="text" placeholder="Search" @keyup="searchBlood(true)" id="searchBarBlood">
                                    <div class="button" @click="addBloodBankModel">
                                        Add blood
                                    </div>
                                </div>
                            </div>
                            <div class="table-body">
                                <table class="student-data">
                                    ...
                                    <tr class="searchtab rowBlood" v-for="bloodInventory in bloodInventories" :key="bloodInventory.id">
                                        <td>{{ 1 }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="" v-if="$page.props.auth.user.id == bloodInventory.user_id">
                                                ...
                                                <div class="grid">
                                                    <div class="form-group">
                                                        <select v-model="bloodForm.blood_group">
                                                            ...
                                                            <option v-for="bloodGroups in bloodGroup" :key="bloodGroups.id" :value="bloodGroups.id">{{ bloodGroups.blood_name }}</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
