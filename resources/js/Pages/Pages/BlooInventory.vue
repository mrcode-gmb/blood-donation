...
const submitStatus = function (hospital_id, id) {
  if (hospital_id) {
    axios
      .post("/buy-need-blood/" + hospital_id + "/" + id, form)
      .then((success) => {
...
window.onclick = function (e) {
  let div = document.getElementsByClassName("modal-burking");
            ...
            <div class="full-chart">
              <div class="chart-title flex-class">
                ...
                <div class="circle-text">
                  <p>Your can burking a blood from other hospitals</p>
                </div>
              </div>
            </div>
              ...
              <div class="table-body">
                <table class="student-data">
                  ...
                  <tr
                    ...
                    v-for="(bloodInventories, index) in bloodInventory"
                  ...
                  >
                    ...
                    <td>
                      <div class="status-approved" v-if="bloodInventories.is_active == 1">
                        Availabe
                      </div>
                    </td>
                    <td>
                      <a
                        href="#!"
                        @click="openModal(bloodInventories.id)"
                        v-if="$page.props.auth.user.role == 4"
                      >
                        <i class="fa fa-plus-circle view"></i>
                      </a>
                    </td>

                    <div class="modal-burking modal d-none" :id="bloodInventories.id">
                      <div class="modal-dialog">
                        ...
                        <form
                          ...
                          @submit.prevent="
                            submitStatus(
                              bloodInventories.hospital_id,
                              bloodInventories.invent_id
                            )
                          "
                        >
                          <div class="form-body">
                            <div class="form-group">
                              <textarea name="" v-model="form.comment">{{
                                bloodInventories.id
                              }}</textarea>
                            </div>
                          </div>
