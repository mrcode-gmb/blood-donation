...
const submitStatus = function (hospital_id, id) {
    if (hospital_id) {
        axios.post("/buy-need-blood/" + hospital_id + "/" + id, form).then(success => {
                            ...
                            <div class="table-body">
                                <table class="student-data">
                                    ...
                                    <tr class="searchtab rowBlood" v-for="bloodInventories in bloodInventory"
                                        ...
                                        <td>
                                            <a href="#!" @click="openModal(bloodInventories.id)" v-if="$page.props.auth.user.role == 4">
                                        ...
                                        <div class="modal d-none" :id="bloodInventories.id">
                                            <div class="modal-dialog">
                                                ...
                                                <form class="modal-body"
                                                    @submit.prevent="submitStatus(bloodInventories.hospital_id, bloodInventories.invent_id)">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <textarea name=""
                                                                v-model="form.comment">{{ bloodInventories.id }}</textarea>
                                                        </div>
                                                    </div>
